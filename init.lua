...
require('packer').startup(function(use)
  ...
  use { -- Autocompletion
    'hrsh7th/nvim-cmp',
    requires = { 'hrsh7th/cmp-nvim-lsp', 'L3MON4D3/LuaSnip', 'saadparwaiz1/cmp_luasnip', "quangnguyen30192/cmp-nvim-ultisnips", 'SirVer/ultisnips'  },
  }
...
vim.api.nvim_set_keymap('n', '<C-c>', '<ESC> :w <CR> :!g++ -fsanitize=address -std=c++17 -Wall -Wextra -Wshadow -DONPC -O2 -o %< % && ./%< < %:p:h/inp<CR>', {noremap = true})
vim.api.nvim_set_keymap('i', '<C-c>', '<ESC> :w <CR> :!g++ -fsanitize=address -std=c++17 -Wall -Wextra -Wshadow -DONPC -O2 -o %< % && ./%< < %:p:h/inp<CR>', {noremap = true})
